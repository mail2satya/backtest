...
archives_json = '[{"name":"F&O - UDiFF Common Bhavcopy Final (zip)","type":"archives","category":"derivatives","section":"equity"}]'
encoded_archives = urllib.parse.quote(archives_json)
URL_TEMPLATE = (
